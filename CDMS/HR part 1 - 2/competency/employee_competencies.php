...
$query = "SELECT * FROM `employeecompetencies`"; 
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" href="competencies.php">Competencies <b>|</b></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="competency_level.php">Competency level <b>|</b></a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" href="employee_competencies.php">Employee competencies</a>
                            </li>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="view-button" data-bs-toggle="modal" data-bs-target="#viewModal" data-case-id="<?php echo $row['RecordID']; ?>">
                                    <i class='fas fa-eye'></i>
                                </a>    <b> |</b>

                                <form action="approved.php?id=<?php echo $row['RecordID']; ?>" method="POST" style="display: inline;">
                                    <button type="submit" class="approve-button" style="border: none; padding: 0;">
                                        <i class="fas fa-check"></i>
                                    </button>
                                   <b> |</b>
                                </form>
                                <form action="rejected.php?id=<?php echo $row['RecordID']; ?>" method="POST" style="display: inline;">
                                    <button type="submit" class="reject-button" style="border: none;  padding: 0;">
                                        <i class="fas fa-times"></i>
                                    </button>
                                    <b> |</b>
                                </form>
                                <form action="delete.php?id=<?php echo $row['RecordID']; ?>" method="POST" style="display: inline;">
