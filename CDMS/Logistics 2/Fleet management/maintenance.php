<?php 
   ...
   $stmt = $conn->prepare("SELECT * FROM maintenancelogs");
   $stmt->execute();
...
<h2 class="pt-6 pl-6 text-xl font-medium mb-4 text-gray-800">Maintenance Log</h2>
<table class="styled-table">
    ...
    <tbody>
        <?php foreach ($maintenancelogs as $row) : ?>
            <tr>
                <td><?php echo htmlspecialchars($row['MaintenanceID']); ?></td>
                ...
                <td><?php echo htmlspecialchars($row['NextMaintenanceDate']); ?></td>
                <td><?php echo htmlspecialchars($row['Cost']); ?></td>
                <td><?php echo htmlspecialchars($row['Status']); ?></td>
                <td>
                <div class="d-flex gap-2 align-items-center">
                    <!-- Add Mileage Button  -->
                    <a href="#" id="addMaintenanceLogBtn"
                    ...
                    <a href="#" class="view-btn bg-blue-600 text-white w-[70px] p-2 rounded-lg inline-block text-center"
                       data-bs-toggle="modal"
                       data-bs-target="#maintenanceviewModal"
                       data-maintenanceid="<?php echo htmlspecialchars($row['MaintenanceID']); ?>"
                       data-vehicleid="<?php echo htmlspecialchars($row['VehicleID']); ?>"
                       data-maintenancetype="<?php echo htmlspecialchars($row['MaintenanceType']); ?>"
                       data-description="<?php echo htmlspecialchars($row['Description']); ?>"
                       data-maintenancedate="<?php echo htmlspecialchars($row['MaintenanceDate']); ?>"
                       data-nextmaintenancedate="<?php echo htmlspecialchars($row['NextMaintenanceDate']); ?>"
                    ...
                    <a href="#" class="delete-btn bg-red-600 text-white w-[70px] p-2 rounded-lg inline-block text-center"
                       data-bs-toggle="modal"
                       data-bs-target="#maintenanceDeleteModal"
                       data-maintenanceid="<?php echo htmlspecialchars($row['MaintenanceID']); ?>">
...
<div id="addMaintenanceLogModal" class="modal fade" tabindex="-1">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="add.php" method="POST">
          <div class="mb-3">
            <label for="MaintenanceID" class="form-label">Maintenance Log ID:</label>
            <input type="text" class="form-control" name="MaintenanceID" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="MaintenanceType" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="datetime-local" class="form-control" name="MaintenanceDate" required>
          </div>
          <div class="mb-3">
            <label for="NextMaintenanceDate" class="form-label">Next Maintenance Date:</label>
            <input type="datetime-local" class="form-control" name="NextMaintenanceDate" required>
          </div>
          <div class="mb-3">
          ...
          <button type="submit" class="btn btn-primary" name="addMaintenance">Submit</button>
        </form>
      </div>
    </div>
  </div>
...
<!-- View Modal -->
<div class="modal fade" id="maintenanceviewModal" tabindex="-1" aria-labelledby="maintenanceviewModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-blue-600 text-white">
                <h5 class="modal-title" id="maintenanceviewModalLabel">Maintenance Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p><strong>Maintenance ID:</strong> <span id="viewMaintenanceID"></span></p>
                <p><strong>Vehicle ID:</strong> <span id="viewVehicleID"></span></p>
                <p><strong>Maintenance Type:</strong> <span id="viewMaintenanceType"></span></p>
                <p><strong>Description:</strong> <span id="viewDescription"></span></p>
                <p><strong>Maintenance Date:</strong> <span id="viewMaintenanceDate"></span></p>
                <p><strong>Next Maintenance Date:</strong> <span id="viewNextMaintenanceDate"></span></p>
...
<form action="edit.php" method="POST" onsubmit="return confirmUpdate();">
    <div class="modal fade" id="maintenanceModal" tabindex="-1" aria-labelledby="maintenanceModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="maintenanceModalLabel">Edit Maintenance Log</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <!-- Hidden field for old Maintenance ID -->
                    <input type="hidden" id="oldMaintenanceID" name="old_maintenance_id">

                    <div class="mb-3">
                        <label for="editMaintenanceID" class="form-label">Maintenance ID</label>
                        <input type="text" class="form-control" id="editMaintenanceID" name="maintenance_id">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="editMaintenanceType" name="maintenance_type">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="editMaintenanceDate" class="form-label">Maintenance Date</label>
                        <input type="datetime-local" class="form-control" id="editMaintenanceDate" name="maintenance_date">
                    </div>
                    <div class="mb-3">
                        <label for="editNextMaintenanceDate" class="form-label">Next Maintenance Date</label>
                        <input type="datetime-local" class="form-control" id="editNextMaintenanceDate" name="next_maintenance_date">
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="maintenanceDeleteModal" tabindex="-1" aria-labelledby="DelModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete <strong id="displayMaintenanceID"></strong>?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <form method="POST" action="delete.php">
                    <input type="hidden" name="maintenance_id" id="hiddenMaintenanceID">
