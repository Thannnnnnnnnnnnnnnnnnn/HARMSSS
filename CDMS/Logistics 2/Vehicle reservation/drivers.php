                ...
                <!-- All Content Put Here -->
                    ...
                    <div class="main-container">
                        ...
                        <div class="main-container-1">
                            ...
                            <span class="a">
                               <a href="sub-modules/available.php">Available
                            ...
                            <span class="b">
                                <a href="sub-modules/not_available.php">Not available
                            ...
                            <span class="c">
                                <a href="sub-modules/on_duty.php">On duty
                            ...
                            <span class="d">
                                <a href="sub-modules/on_leave.php">On leave
                        ...
                        <div class="main-container-2">
                            <span class="e">
                                <a href="sub-modules/on_training.php">On training
                            ...
                            <span class="f">
                                <a href="sub-modules/reserve_drivers.php">Reserved drivers
                            ...
                            <span class="g">
                                <a href="sub-modules/upcoming_drivers.php">Upcoming drivers
                            ...
                            <span class="h">
                                <a href="sub-modules/under_eval.php">Under evaluation
                            ...
                            <span class="i">
                               <a href="sub-modules/AWOL.php">AWOL
