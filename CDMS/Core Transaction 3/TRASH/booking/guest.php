...
<body>
 ...
 <h2 class="text-center text-2xl font-bold text-gray-800 mb-4">Guest Preference</h2>
  ...
  <table class="min-w-full text-sm text-left">
      ...
      <tr class="border-t">
          ...
          <td class="px-4 py-2">Near the pool</td>
          <td>   <button class="bg-blue-600 text-white w-[70px] p-2 rounded-lg">
        ...
        <tr class="border-t">
          ...
          <td class="px-4 py-2">Vegetarian only</td>
          <td>   <button class="bg-blue-600 text-white w-[70px] p-2 rounded-lg">
            <i class="bx bx-show"></i>
          </button></td>
        </tr>
        <tr class="border-t">
          ...
          <td class="px-4 py-2">Daily housekeeping</td>
          <td>   <button class="bg-blue-600 text-white w-[70px] p-2 rounded-lg">
            <i class="bx bx-show"></i>
          </button></td>
        </tr>
