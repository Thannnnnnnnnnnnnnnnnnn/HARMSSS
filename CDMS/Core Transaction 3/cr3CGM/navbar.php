        ...
        <div class="right-nav  items-center space-x-6 hidden lg:flex">
            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="info flex flex-col py-2">
                    <h1 class="text-[#4E3B2A] font-semibold font-serif text-sm"><?php echo $_SESSION['username'] ?></h1>
                    <p class="text-[#594423] text-sm pl-2"><?php echo $_SESSION['role'] ?></p>
                </div>
            </div>
        </div>
    </nav>
...
<?php if ($user['role'] === 'manager' || $user['role'] === 'staff'): ?>
<!-- Main + Navbar -->
<div class="main w-full bg-[#FFF6E8] md:ml-[320px]">
    <!-- Navbar -->
    <nav class="h-16 w-full bg-white border-b border-[#F7E6CA] flex justify-between items-center px-6 py-4">
