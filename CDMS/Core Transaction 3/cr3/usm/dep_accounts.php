...
FROM 
    user_account ua
LEFT JOIN 
    department_accounts da ON ua.user_id = da.user_id";
...
<tr class="border-t">
  ...
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_accounts['first_name']); ?></td>
...
<div id="modalView-<?php echo $dept_accounts['dept_accounts_id']; ?>" class="modal hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
  <div class="bg-white rounded-xl p-6 shadow-xl w-full max-w-md">
    <h2 class="text-xl font-semibold mb-4">View Details</h2>
                ...
                <p><strong>Name:</strong><?php echo htmlspecialchars($dept_accounts['first_name']); ?></span></p>
...
<div id="modalEdit-<?php echo $dept_accounts['dept_accounts_id']; ?>" class="modal hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
  ...
  <div class="mb-4">
    ...
    <input type="text" name="username" value="<?php echo htmlspecialchars($dept_accounts['username']); ?>" class="w-full border border-gray-300 p-2 rounded-md">
  </div>
...
<div id="modalInfo-<?php echo $dept_accounts['dept_accounts_id']; ?>" class="modal hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
  ...
  <div class="mb-4">
    ...
    <input type="text" name="first_name" value="<?php echo htmlspecialchars($dept_accounts['first_name']); ?>" class="w-full border border-gray-300 p-2 rounded-md" >
  </div>

  <div class="mb-4">
    <label class="block font-semibold">Last name:</label>
    <input type="text" name="last_name" value="<?php echo htmlspecialchars($dept_accounts['last_name']); ?>" class="w-full border border-gray-300 p-2 rounded-md" >
  </div>
...
<?php endforeach; ?>
  ...
  <!-- staff ------------------------------------------------------------------------------------------------------------------->
     <?php if ($user['role'] === 'staff'): ?> 
            ...
            <h2 class="text-center text-2xl font-bold text-gray-800 mb-1">My accounts</h2>
            <div class="bg-gradient-to-b to-orange-100 min-h-screen p-8">
...
<tr class="border-t">
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_accounts['user_id']); ?></td>
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_accounts['first_name']); ?></td>
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_accounts['last_name']); ?></td>
   <td class="px-4 py-2"><?php echo htmlspecialchars($dept_accounts['role']); ?></td>
