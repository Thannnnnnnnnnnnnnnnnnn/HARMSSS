    ...
    <div class="flex min-h-screen w-full">
                ...
                <ul class="space-y-4">
                    ...
                    <div class="menu-option">
                        ...
                        <div id="disbursement-dropdown" class="menu-drop hidden flex-col w-full bg-[#F7E6CA] rounded-lg p-4 space-y-2 mt-2">
                            <ul class="space-y-1">
                                <li><a href=".../rs.php" class="text-sm text-gray-800 hover:text-blue-600">Reservation Status</a></li>
                                <li><a href="room.php" class="text-sm text-gray-800 hover:text-blue-600">Room Status</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="menu-option">
        ...
        <div class="main w-full bg-[#FFF6E8] md:ml-[320px]">
            ...
            <main class="px-4 py-4">
                ...
                <h2 class="text-center text-2xl font-bold text-gray-800 mb-4">Reservation Table</h2>
                ...
                <div class="bg-gradient-to-b from-white to-orange-100 min-h-screen p-8">
                        ...
                        <table class="min-w-full h-50 text-[12px] text-left">
                            <thead class="bg-[#f1ddbe] text-black uppercase">
                                <tr>
                                    ...
                                    <th class="px-4 py-3">Guest ID</th>
                                    <th class="px-4 py-3">Check In Date</th>
                                    <th class="px-4 py-3">Check Out Date</th>
                                    <th class="px-4 py-3">Room Number</th>
                                    <th class="px-4 py-3">No. of Guests</th>
                                    <th class="px-4 py-3">Status</th>
                                    <th class="px-4 py-3">Booking Channel ID</th>
                                    <th class="px-4 py-3">Special Requests</th>
                            ...
                            <tbody>
                                ...
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2">A101</td>
                                    <td class="px-4 py-2">2</td>
                                    <td class="px-4 py-2 bg-green-200 text-green-800 px-2 py-1 rounded">Confirmed</td>
                                    <td class="px-4 py-2">3</td>
                                    <td class="px-4 py-2">Vegetarian meals only</td>
                                ...
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2">B201</td>
                                    <td class="px-4 py-2">4</td>
                                    <td class="px-4 py-2 bg-yellow-200 text-yellow-800 px-2 py-1 rounded">Pending</td>
                                    <td class="px-4 py-2">2</td>
                                    <td class="px-4 py-2">Late check-in</td>
                                    <td><button class="bg-blue-600 text-white w-[70px] p-2 rounded-lg"><i class="bx bx-show"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2">2025-04-25</td>
                                    <td class="px-4 py-2">2025-04-28</td>
                                    <td class="px-4 py-2">D401</td>
                                    <td class="px-4 py-2">3</td>
                                    <td class="px-4 py-2 bg-red-200 text-red-800 px-2 py-1 rounded">Cancelled</td>
                                    <td class="px-4 py-2">4</td>
                                    <td class="px-4 py-2">Wheelchair accessible room</td>
                                    <td><button class="bg-blue-600 text-white w-[70px] p-2 rounded-lg"><i class="bx bx-show"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2">2025-04-20</td>
                                    <td class="px-4 py-2">E505</td>
                                    <td class="px-4 py-2">2</td>
                                    <td class="px-4 py-2 bg-yellow-200 text-yellow-800 px-2 py-1 rounded">Pending</td>
                                    <td class="px-4 py-2">3</td>
                                    <td class="px-4 py-2">Anniversary setup</td>
                                    <td><button class="bg-blue-600 text-white w-[70px] p-2 rounded-lg"><i class="bx bx-show"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2">2025-04-06</td>
                                    <td class="px-4 py-2">F601</td>
                                    <td class="px-4 py-2">1</td>
                                    <td class="px-4 py-2 bg-green-200 text-green-800 px-2 py-1 rounded">Confirmed</td>
                                    <td class="px-4 py-2">2</td>
                                    <td class="px-4 py-2">Airport pickup</td>
                                    <td><button class="bg-blue-600 text-white w-[70px] p-2 rounded-lg"><i class="bx bx-show"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2">2025-04-08</td>
                                    <td class="px-4 py-2">2025-04-09</td>
                                    <td class="px-4 py-2">G701</td>
                                    <td class="px-4 py-2">2</td>
                                    <td class="px-4 py-2 bg-red-200 text-red-800 px-2 py-1 rounded">Cancelled</td>
                                    <td class="px-4 py-2">1</td>
                                    <td class="px-4 py-2">None</td>
                                ...
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2">2025-04-11</td>
                                    <td class="px-4 py-2">2025-04-13</td>
                                    <td class="px-4 py-2">H801</td>
                                    <td class="px-4 py-2">5</td>
                                    <td class="px-4 py-2 bg-yellow-200 text-yellow-800 px-2 py-1 rounded">Pending</td>
                                    <td class="px-4 py-2">4</td>
                                    <td class="px-4 py-2">Group stay</td>
                                    <td><button class="bg-blue-600 text-white w-[70px] p-2 rounded-lg"><i class="bx bx-show"></i></button></td>
                                </tr>
                                ...
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2">I901</td>
                                    <td class="px-4 py-2">2</td>
                                    <td class="px-4 py-2 bg-green-200 text-green-800 px-2 py-1 rounded">Confirmed</td>
                                    <td class="px-4 py-2">1</td>
                                    <td class="px-4 py-2">Sea view</td>
                                    <td><button class="bg-blue-600 text-white w-[70px] p-2 rounded-lg"><i class="bx bx-show"></i></button></td>
                                </tr>
                    ...
                    <div class="flex items-center justify-between mt-4">
                        ...
                        <div class="flex items-center space-x-1">
                            <button class="px-3 py-1 bg-[#f1ddbe]  hover:bg-gray-300 rounded-md">
                                << /button>
