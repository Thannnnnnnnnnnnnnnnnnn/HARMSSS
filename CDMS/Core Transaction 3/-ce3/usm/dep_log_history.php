...
$sql = "SELECT * FROM department_log_history";
$stmt = $conn->prepare($sql); 
$stmt->execute(); // ✅ Don't forget to execute!
$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>

<?php foreach ($result as $dept_log): ?>
<tr class="border-t">
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_log['Dept_Logt_ID']); ?></td>
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_log['Department_ID']); ?></td>
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_log['User_LogID']); ?></td>
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_log['User_ID']); ?></td>
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_log['Failure_reason']); ?></td>
  <td class="px-4 py-2 bg-green-200 text-green-800 px-2 py-1 rounded"><?php echo htmlspecialchars($dept_log['Log_Status']); ?></td>
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_log['Log_DateTime']); ?></td>
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_log['Role']); ?></td>
  <td class="px-4 py-2"><?php echo htmlspecialchars($dept_log['User_name']); ?></td>

  <td>
    <button class="bg-blue-600 text-white w-[70px] p-2 rounded-lg">
