    ...
    <div class="h-16 border-b border-[#F7E6CA] flex items-center">
        <?php
            ...
            $modules = [
                ...
                'Budget_Management' => [
                    'path' => 'financial2/Budget_Management/',
                ...
                'General_Ledger' => [
                    'path' => 'financial2/General_Ledger/',
                ...
                'Account_Payable' => [
                    'path' => 'financial2/Account_Payable/',
                ...
                'User_Management' => [
                    'path' => 'financial2/User_Management/',
