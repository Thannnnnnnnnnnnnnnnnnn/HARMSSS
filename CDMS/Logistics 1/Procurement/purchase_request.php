...
$query = "SELECT 
        ...
        (SELECT COUNT(*) FROM purchase_request WHERE status = 'Denied request') AS Denied_request,
        (SELECT COUNT(*) FROM purchase_request WHERE status = 'Clearance approve') AS Clearance_approve
";
                    ...
                    <div id="audit-dropdown" class="menu-drop hidden flex-col w-full bg-[#EBD8B6] rounded-lg p-3 space-y-1 mt-1">
                        ...
                        <li>
                                <a href="purchase_request" class="text-sm text-gray-800 hover:bg-[#F7E6CA] flex items-center space-x-2 p-2 rounded-lg">
                                    <i class="bx bx-shield text-lg"></i> <span>Purchase_request</span>
                                    </a>
                                </li>
                                <li>
