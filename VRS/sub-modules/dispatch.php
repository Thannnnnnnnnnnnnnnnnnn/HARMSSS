...
$query = "SELECT * FROM `reservation` WHERE status = 'Dispatch'"; // Adjust the query as needed
$result = mysqli_query($connection, $query);
                ...
                <tr class="driver-row" 
                   ">
                    ...
                    <td>
                                ...
                                <form action="../mark1.php?id=<?php echo $row['ReservationID']; ?>" method="POST" style="display: inline;">
                                ...
                                <form action="../mark2.php?id=<?php echo $row['ReservationID']; ?>" method="POST" style="display: inline;">
