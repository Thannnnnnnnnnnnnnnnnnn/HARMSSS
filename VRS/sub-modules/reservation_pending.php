...
$query = "SELECT * FROM `reservation` WHERE status = 'Pending'"; // Adjust the query as needed
$result = mysqli_query($connection, $query);
                ...
                <tr class="driver-row" 
                   ">
                    ...
                    <td>
                                 ...
                                 <form action="../disbatch.php?id=<?php echo $row['ReservationID']; ?>" method="POST" style="display: inline;">
                                    <button type="submit" class="dispatch-button" style="border: none; padding: 0;">
                                        <i class="fas fa-check"></i>
                                    </button>
                                   <b> |</b>
                                </form>
                                <form action="../decline.php?id=<?php echo $row['ReservationID']; ?>" method="POST" style="display: inline;">
                                    <button type="submit" class="decline-button" style="border: none;  padding: 0;">
